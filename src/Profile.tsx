...
const Profile: React.FC = () => {
  ...
  return (
    <div style={{ maxWidth: 400, margin: '2rem auto', padding: '2rem', background: '#fffdf8', borderRadius: 16, boxShadow: '0 2px 16px rgba(0,0,0,0.10)' }}>
      <h2 className="iv-display" style={{ fontSize: '2rem', fontWeight: 600, marginBottom: '1rem', color: '#9a6b3f' }}>Edit Profile</h2>
      {user ? (
        <form onSubmit={handleSave} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <button type="submit" disabled={loading} style={{ padding: '10px 32px', borderRadius: 8, background: 'linear-gradient(to right, #9a6b3f, #9333ea)', color: '#fffdf8', fontWeight: 600, border: 'none', cursor: 'pointer', fontSize: '1rem', boxShadow: '0 2px 8px rgba(0,0,0,0.08)' }}>Save</button>
